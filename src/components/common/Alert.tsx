    ...
    <div className={`rounded-md border p-4 ${style.container}`}>
      <div className="flex">
        ...
        <div className="ml-3 flex-1">
          ...
          <div className={`text-sm ${style.content} ${title ? 'mt-1' : ''}`}>
            {children}
          </div>
        </div>
        {onClose && (
          <div className="ml-auto pl-3">
            <button
              onClick={onClose}
              className={`inline-flex rounded-md p-1.5 hover:bg-opacity-20 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 ${style.icon}`}
            >
